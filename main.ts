...
// Version 1: hacer laberinto.
let myEnemy: Sprite = null
let Disparo: Sprite = null
let DireccionDisparo = 0
...
game.onUpdateInterval(5000, function () {
    ...
    tiles.placeOnRandomTile(myEnemy, myTiles.transparency16)
